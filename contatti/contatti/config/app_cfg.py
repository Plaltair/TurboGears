# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in contatti.
...
import contatti
from contatti import model, lib
...
base_config.update_blueprint({
    'use_sqlalchemy': True,
    'model': contatti.model,
    'DBSession': contatti.model.DBSession,
})
...
class ApplicationAuthMetadata(TGAuthMetadata):
    ...
    def get_user(self, identity, email):
...
base_config.update_blueprint({
    ...
    'sa_auth.cookie_secret': "a5ef4b40-e42c-4a7a-bb3c-e0e4f177b026",
